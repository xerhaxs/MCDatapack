...
execute as @a at @s[gamemode=survival,nbt={Inventory:[{id:"minecraft:structure_void"}]}] run give @s minecraft:enderman_spawn_egg{display:{Name:'{"text":"Lightblock_Delete"}'},EntityTag:{id:"minecraft:area_effect_cloud",Particle:"block air",NoGravity:1b,Radius:0f,RadiusPerTick:0f,RadiusOnUse:0f,Duration:1,Tags:["lightblock_delete"]}} 1
...
execute as @e[tag=lightblock_delete] at @s if entity @e[tag=lightblock,distance=..1] run give @p minecraft:blaze_spawn_egg{display:{Name:'{"text":"Lightblock"}'},EntityTag:{id:"minecraft:armor_stand",NoGravity:1b,Silent:1b,Invulnerable:1b,ShowArms:0b,Small:1b,Marker:1b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,Tags:["lightblock"]}} 1
execute as @e[tag=lightblock_delete] at @s run kill @e[tag=lightblock,distance=..1]
execute as @e[tag=lightblock_delete] at @s run setblock ~ ~ ~ minecraft:air
execute as @e[tag=lightblock_delete] at @s run give @p minecraft:enderman_spawn_egg{display:{Name:'{"text":"Lightblock_Delete"}'},EntityTag:{id:"minecraft:area_effect_cloud",Particle:"block air",NoGravity:1b,Radius:0f,RadiusPerTick:0f,RadiusOnUse:0f,Duration:1,Tags:["lightblock_delete"]}} 1
execute as @e[tag=lightblock_delete] at @s run kill @e[tag=lightblock_delete]
